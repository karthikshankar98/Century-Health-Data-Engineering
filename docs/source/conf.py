...
# century_health_pipeline documentation build
...
from century_health_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "century_health_pipeline"
author = "Kedro"
...
htmlhelp_basename = "century_health_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "century_health_pipeline.tex",
        "century_health_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "century_health_pipeline",
        "Project century_health_pipeline codebase.",
        "Data-Science",
    )
]
